<template>
    <svg
        ...
        style="enable-background:new 0 0 219.15 219.15;"
        xml:space="preserve"
        height="36pt"
        width="36pt"
    >
        <g>
            <path
                d="M109.575,0C49.156,0,0.002,49.155,0.002,109.574c0,60.42,49.154,109.576,109.573,109.576s109.573-49.156,109.573-109.576
            ...
            />
            <path
                d="M109.576,152.243c-5.738,0-10.406,4.667-10.406,10.403c0,5.743,4.668,10.415,10.406,10.415
            ...
            />
            <path
                d="M109.575,46.089c-19.154,0-34.737,15.583-34.737,34.736c0,4.142,3.358,7.5,7.5,7.5c4.142,0,7.5-3.358,7.5-7.5
